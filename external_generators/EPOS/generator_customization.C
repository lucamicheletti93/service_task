...
void generator_customization(AliGenerator* generator)
{
  ...
  /// myCode
	...
	((AliGenExtExec*) generator)->SetPathScript("$ALICE_PHYSICS/PWG/MCLEGO/EPOS/gen_epos3.sh");
	((AliGenExtExec*) generator)->SetInput(AliGenExtExec::kEPOSroot);
	((AliGenExtExec*) generator)->SetMode(AliGenExtExec::kAlternatingFiles);
