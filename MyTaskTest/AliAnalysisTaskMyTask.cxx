...
AliAnalysisTaskMyTask::AliAnalysisTaskMyTask() : AliAnalysisTaskSE(),
    fAOD(0), fOutputList(0), fHistPt(0), fHistMult(0)
{
...
void AliAnalysisTaskMyTask::UserCreateOutputObjects()
{
    ...
    fHistMult = new TH1F("fHistMult", "fHistMult", 200, 0, 200);       // create your histogra
    fHistMass = new TH1F("fHistMass", "fHistMass", 100, 0, 5);       // create your histogra
...
*/
    ...
    for(Int_t i = 0; i < nTracks;i++){
      ...
      fHistMass->Fill(track->GetCalcMass());
    }
